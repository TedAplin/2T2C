...
If you place a pre-made Batch data-set in the Input/Individual folder then you can load it here.

If it returns "no such file or directory" or "cannot open the connection" then your file is not in the Input/Individual folder, or you have misspelled it.
...
# Creating dataset from supplied files
BatchData <- read.csv(here("Input", "Individual", FileName))
```
